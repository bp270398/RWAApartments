<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Administration.Login" %>
        ...
        <asp:Panel ID="PanelForma" runat="server" Visible="True">
            ...
            <fieldset class="p-4">
                ...
                <div class="mb-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" meta:resourcekey="rfvUsername" runat="server" ControlToValidate="txtUsername" Display="Dynamic" ForeColor="Red" ErrorMessage="This is a required field"></asp:RequiredFieldValidator>
                </div>
                <div class="mb-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" meta:resourcekey="rfvPassword" runat="server" ControlToValidate="txtPassword" Display="Dynamic" ForeColor="Red" ErrorMessage="This is a required field"></asp:RequiredFieldValidator>
                </div>
